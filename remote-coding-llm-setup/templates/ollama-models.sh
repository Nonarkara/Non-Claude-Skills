#!/bin/bash
# =============================================================================
# Ollama + Recommended Models for M3 MacBook Air (16GB / 256GB)
...
echo ""
echo "Pulling recommended models for M3 16GB..."
echo "  qwen2.5:14b   (~9 GB)    — all-purpose: code, analysis, writing"
echo "  phi3:mini      (~2.3 GB)  — fast chat"
echo "  Total: ~11 GB"
echo ""

ollama pull qwen2.5:14b && info "qwen2.5:14b ready" || err "Failed to pull qwen2.5:14b"
...
echo ""
echo "  Usage:"
echo "    ollama run qwen2.5:14b         # All-purpose (code, analysis, writing)"
...
echo "    ollama pull qwen2.5-coder:14b   # Dedicated coding model (+9 GB)"
